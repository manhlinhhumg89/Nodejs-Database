...
let insertPgDBForLogSale = function (data, callback) {
    let rawQuery = {
        query: "INSERT INTO " + TABLE_SALE + " (user_id,product_id,type,price,created_at,last_update,type_name,source,rw_expire) VALUES ($1,$2,$3,$4,$5,$6,$7,$8,$9) RETURNING id ",
        data: [data.user_id, data.product_id, data.type, data.price, data.created_at, data.last_update, data.type_name, data.source, data.rwExpire]
    }
                ...
                if (record.length == 0) {
                    ...
                    let rawQuery = {
                        query: "INSERT INTO " + tableName + "(id,register_date,last_sync,premium_date,country,android,ios"
                            + ",web,winphone,windows,premium_status,num_wallet,deactive_status,last_update)" +
